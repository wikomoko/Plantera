...
class ProductData {
    ...
    val image_of_products = intArrayOf(
        R.drawable.carrot,
        R.drawable.pok_choy,
        R.drawable.paprica,
        R.drawable.potato,
    ...
    val desc_of_products = arrayOf(
        ...
        "Corn, also known as maize (North American and Australian English), is a cereal grain that was first domesticated by indigenous peoples in southern Mexico about 10,000 years ago. The leafy stalks produce pollen and ovulaferous inflorescences which are separate inflorescences called ears which produce the kernel or seeds, which are fruits. Corn has become a staple food in many parts of the world, with total maize production exceeding that of wheat or rice . Apart from being consumed directly by humans (often in the form of mass), corn is also used for corn ethanol, animal feed and other corn products, such as corn starch and corn syrup. The six main types of corn are crooked corn , rock corn , peas corn , popcorn , flour corn , and sweet corn . The sugar-rich variety called sweet corn is usually grown for human consumption as a kernel, while the field corn variety is used for animal feed, various human food uses based on corn (including milling into corn flour or masa, pressing into corn oil, and fermentation and distillation into a beverage. alcoholic beverages such as bourbon whiskey), and as a chemical feedstock. Corn is also used in the manufacture of ethanol and other biofuels.",
